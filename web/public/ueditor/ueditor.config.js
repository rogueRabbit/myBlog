...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'print', 'preview', 'searchreplace', 'drafts', 'help', 'addpicture'
        ]]
        ...
        ,whitList: {
            ...
            iframe :['class' , 'style' , 'src', 'frameborder', 'width', 'height', 'allowfullscreen','video_url','max-width','max-height','align','frameborder']
        }
    };
